...
(function () {
    ...
    var loadChat = function (cb) {
        ...
        $.get("https://rawgit.com/lisbr/David_Madsen/master/lang/langIndex.json", function (json) {
    ...
    var basicBot = {
        ...
        name: "basicBot",
        loggedInID: null,
        scriptLink: "https://rawgit.com/lisbr/David_Madsen/master/basicBot.js",
        ...
        settings: {
            ...
            ball: [
            "Chloe disse que sim.",
            "Mas o que foi que disse? Você parece a Max falando assim..",
            "Sem dúvidas.",
            "Quem sabe a Rachel possa te responder isso, seja lá onde ela esteja...",
            "Pelo que eu vejo, sim.",
            "Depende. Você é amigo(a) da Chloe?",
            "Aposto que você é um desses amigos da Chloe que fumam maconha, não é? ",
            "Chloe disse que não.",
            "Chloe disse que talvez...",
            "Melhor não te contar agora, Joyce está rindo muito do que você disse hahaha",
            "Bem duvidoso.",
            "Sim, definitivamente.",
            "Desculpe, não entendi o que você disse. Você tem um bafo de bebida pior que o diretor de Blackwell...",
            "Esqueça isso."
            ],
            afkpositionCheck: 15,
